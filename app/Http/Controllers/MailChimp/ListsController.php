...
class ListsController extends Controller
{
    ...
    /**
     * Retrieve and return Members under a MailChimp list.
     *
     * @param string $listId
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public function listMembers(string $listId): JsonResponse
    {
        /** @var \App\Database\Entities\MailChimp\MailChimpList|null $list */
        $list = $this->entityManager->getRepository(MailChimpList::class)->find($listId);
        ...
        try {
            // Get members from a list from mailchimp directly
        ...
        return $this->successfulResponse($result->toArray());
    }
